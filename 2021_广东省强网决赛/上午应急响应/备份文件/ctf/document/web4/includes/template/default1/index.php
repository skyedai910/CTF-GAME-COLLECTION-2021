...
<head>
  ...
  <meta name="keywords" content="<?php echo $conf['web_keywords']?>">
  <meta name="description" content="<?php echo $conf['web_description']?>">
  <meta name="author" content="open.axiwl.cn">
  <title><?php echo $conf['web_name']?> - 会支付会生活</title>
  <link rel="shortcut icon" href="/favicon.ico" />
  <link rel="apple-touch-icon" sizes="76x76" href="/favicon.ico">
   <link rel="stylesheet" href="./template/default1/css/nucleo.css" type="text/css">
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
  <link rel="stylesheet" href="./template/default1/css/open.min.css" type="text/css">
...
<body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="/SDK/" class="nav-link">
              <span class="nav-link-inner--text">在线测试</span>
            </a>
          </li>
		  <li class="nav-item">
			<a href="/order/" class="nav-link" target="_blank">
          ...
          <li class="nav-item">
            <a onclick="return confirm('请直奔主题,不要问在不在,节省彼此的时间')" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['web_qq']; ?>&site=qq&menu=yes" class="nav-link">
  ...
  <div class="main-content">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                ...
                <h2 class="display-4 text-white font-weight-light"><font style="text-transform: uppercase;"><?php echo $_SERVER['HTTP_HOST']?></font>我们专注的每一面<br>都是为了给你更好的体验</h2>
                <p class="text-white mt-4"><?php echo $conf['web_name']?>,以信誉求市场,以稳定求发展，行业内最安全，简单易用，专业的技术团队，最放心的免签约支付平台。</p>
                <div class="mt-5">
                  <a href="/user/" class="btn btn-neutral my-2">商户中心</a>
                  <a href="/doc.php" class="btn btn-default my-2">开发文档</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <p class="description mt-3">您的企业网站可以通过<?php echo $conf['web_name']?>为用户提供统一虚拟账户，提升用户支付体验，为拓展增值服务提供基础。</p>
                    <div>
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <p class="description mt-3">OPEN易支付通过简单的页面配置，可以替代复杂繁琐的人工资金结算业务，提高业务实时性，降低错误。</p>
                    <div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="/assets/images/landing-1.jpg" class="img-fluid">
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              <h1>聚合钱包，融合支付</h1>
              <p><?php echo $conf['web_name']?>通过简单的页面配置，可以替代复杂繁琐的人工资金结算业务，提高业务实时性，降低错误。</p>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <img src="/assets/images/landing-2.jpg" class="img-fluid">
          </div>
          <div class="col-md-6">
            <div class="pr-md-5">
              <h1>高效技术服务</h1>
              <p>我们提供7X24小时在线服务，对日交易高额用户提供贵宾服务！用最具影响力品牌协助，并全力协助新兴品牌，我们以设计助力众多品牌走向行业领先地位，鼎力相助每一个梦想。</p>
              <a onclick="return confirm('请直奔主题,不要问在不在,节省彼此的时间,懂?')" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['web_qq']; ?>&site=qq&menu=yes" class="font-weight-bold text-warning mt-5">联系客服</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="/assets/images/landing-3.jpg" class="img-fluid">
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              <h1>快速资金回笼</h1>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              ...
              <a href="/doc.php" target="_blank" class="btn btn-default mt-3 mt-md-0">开发文档</a>
            </div>
          </div>
        </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="http://pay.xyuds.cn/" class="nav-link" target="_blank">备案号：<?php echo $conf['beian']; ?></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <script src="./template/default1/js/jquery.min.js"></script>
  <script src="./template/default1/js/bootstrap.bundle.min.js"></script>
  <script src="./template/default1/js/js.cookie.js"></script>
  <script src="./template/default1/js/jquery.scrollbar.min.js"></script>
  <script src="./template/default1/js/jquery-scrollLock.min.js"></script>
  <script src="./template/default1/js/jquery.lavalamp.min.js"></script>
  <script src="./template/default1/js/open.min.js"></script>
  <?php echo $conf['footcode']; ?>
</body>
</html>